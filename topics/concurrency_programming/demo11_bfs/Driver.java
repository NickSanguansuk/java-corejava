package topics.concurrency_programming.demo11_bfs;
...
public class Driver {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(t3.getName() + " ---> " + t3.getState()); // TIMED_WAITING ---> sleep()
        ...
        //}
        //
        //System.out.println(t6.getName() + " ---> " + t6.getState()); // WAITING ---> wait for join()
